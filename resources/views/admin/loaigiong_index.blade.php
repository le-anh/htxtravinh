...
<div class="page-inner">
  <header class="page-title-bar">
    ...
    <a href=" {{ route('admin.loaigiong.create') }} "> <button type="button" class="btn btn-success btn-floated"><span class="fa fa-plus"></span></button> </a>
        ...
        <table id="table-datatable-default" class="table">
          ...
          <tr>
            ...
            <td class="text-center">
              <form action="{{route('admin.loaigiong.delete', ['id'=>$loaiGiong->id])}}" method="post">
                @csrf()
                @method('DELETE')
                <a href="{{ route('admin.loaigiong.edit', ['id' => $loaiGiong->id]) }}" class="btn btn-warning btn-sm btn-icon " title="Chỉnh sửa"><i class="fa fa-pencil-alt"></i></a>
